...
The audit log feature is widely described in [📖docs for Elasticsearch plugin](../elasticsearch.md#audit). Kibana plugin has predefined dashboard representing collected audit data.
...
![loading visualization](<../.gitbook/assets/load\_audit\_dashboard%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(4\)%20\(6\)%20\(7\).png>)
