...
| getCookies()                                                           | string or undefined          | 'cookie value'                                                               | Get the request cookies                                                        |
| getMethod()                                                            | Method                       | 'GET'                                                                        | Get the request method                                                         |
| getPath()                                                              | string                       | '/s/default/internal/bsearch'                                                | Get the request path                                                           |
| getUrl()                                                               | string                       | '/s/default/internal/bsearch?compress=true'                                  | Get the request URL                                                            |
| getBody()                                                              | Body or null or undefined    | { id: 42 }                                                                   | Get the request body                                                           |
| getParams()                                                            | ParamsDictionary             | { id: '1234' }                                                               | Get URL parameters                                                             |
| getQueries()                                                           | ParsedQs                     | { compress: 'true' }                                                         | Get query string parameters                                                    |
| getOriginAddress()                                                     | string or undefined          | 172.17.0.1                                                                   | Get the origin address                                                         |
| getHeaders()                                                           | Headers                      | { connection: 'keep-alive','sec-ch-ua': cookie: 'cookieValue' ... }          | Get all request headers                                                        |
