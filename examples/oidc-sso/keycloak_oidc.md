...
3. log in as admin
4. Follow the explanation below, or (if your KC version is the same or close enough to this) use the import function to load this [configuration file](../keycloak_ror_OIDC.json)
